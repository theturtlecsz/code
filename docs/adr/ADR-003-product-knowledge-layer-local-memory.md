...
- Canonical statement: `codex-rs/docs/MODEL-POLICY.md:21`
- Project tracker statement: `codex-rs/SPEC.md:32`

### OverlayDb is SoR for vision (not capsule)

- Vision persistence core: `codex-rs/tui/src/chatwidget/spec_kit/vision_core.rs:40`
- Projection command design notes: `codex-rs/tui/src/chatwidget/spec_kit/commands/projections.rs:1`

### Filesystem is projection; projection failures must not block SoR writes

- Headless intake flow: `codex-rs/cli/src/speckit_cmd.rs:6307`
- Ops contract: `docs/OPERATIONS.md:251`

### local-memory integration discipline (no MCP)

- Stage0 adapters (CLI+REST for local-memory; HTTP-only for NotebookLM): `codex-rs/tui/src/stage0_adapters.rs:1`
- Policy: `/home/thetu/infra/localmemory-policy/skills/local-memory/SKILL.md:43`

### Upstream compatibility

- local-memory must never become “required” for memvid runs; mirror best-effort health gating patterns:
  `codex-rs/tui/src/chatwidget/spec_kit/stage0_integration.rs:263`
...
- Determinism statement: `codex-rs/SPEC.md:69`
- Retrieval event payloads exist: `codex-rs/tui/src/memvid_adapter/mod.rs:124`
...
Ops guidance: `docs/OPERATIONS.md:115`
...
Policy: `/home/thetu/infra/localmemory-policy/skills/local-memory/SKILL.md:51`
...
- OverlayDb Tier2 cache remains the operational cache for quick reuse:
  `codex-rs/stage0/src/overlay_db.rs:153`
...
Reference: `~/local-memory-configs-export/README.md:9`
...
`~/local-memory-configs-export/project-examples/code-project/AGENTS.md:1` is missing the local-memory section.
...
- memvid adjacency/type listing TODOs: `codex-rs/cli/src/speckit_cmd.rs:6006`, `codex-rs/cli/src/speckit_cmd.rs:6020`
- memvid importance-threshold filtering: `codex-rs/tui/src/memvid_adapter/adapter.rs:679`
...
- `codex-rs/docs/MODEL-POLICY.md:21` (capsule SoR)
- `codex-rs/SPEC.md:32` (capsule SoR)
- `codex-rs/SPEC.md:69` (offline replay determinism)
- `codex-rs/tui/src/chatwidget/spec_kit/vision_core.rs:40` (vision persisted to OverlayDb)
- `codex-rs/tui/src/chatwidget/spec_kit/commands/projections.rs:1` (projection rebuild design)
- `codex-rs/cli/src/speckit_cmd.rs:6307` (projection failures must not block SoR writes)
- `docs/OPERATIONS.md:115` (insight content discipline)
- `docs/OPERATIONS.md:251` (capsule as SoR + projections)
- `codex-rs/tui/src/stage0_adapters.rs:1` (CLI+REST local-memory; HTTP NotebookLM)
- `codex-rs/tui/src/chatwidget/spec_kit/stage0_integration.rs:263` (best-effort health gating)
- `codex-rs/tui/src/memvid_adapter/mod.rs:124` (retrieval event payloads)
- `codex-rs/stage0/src/overlay_db.rs:153` (Tier2 cache)
- `/home/thetu/infra/localmemory-policy/skills/local-memory/SKILL.md:43` (no MCP; CLI+REST)
