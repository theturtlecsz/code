...
| ------------------------------------------------------------ | ----------------------------------------------------------------------- | ----------- |
| [SPEC-P0-TUI2-QUARANTINE](./SPEC-P0-TUI2-QUARANTINE/spec.md) | tui2 quarantine: default-members exclusion, scaffold docs, CI guardrail | In Progress |

These are standalone maintenance items outside the 30/60/90 roadmap DAG. They enforce existing governance (ADR-002, constitution) rather than introducing new features.
...
**Navigation**: [KEY\_DOCS.md](KEY_DOCS.md) | [codex-rs/SPEC.md](../codex-rs/SPEC.md) | [VISION.md](VISION.md)
