...
| [`docs/adr/ADR-002-tui2-purpose-and-future.md`](adr/ADR-002-tui2-purpose-and-future.md) | ADR                | UI canon: tui = production, tui2 = scaffold                        |
| [`docs/SPEC-TUI2-STUBS.md`](SPEC-TUI2-STUBS.md)                                         | Inventory          | tui2 stub inventory, cherry-pick workflow, out-of-scope list       |
...
See `docs/DEPRECATIONS.md` and archive packs under `archive/` for the full historical list.
