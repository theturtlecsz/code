...
| [`docs/SPEC-KIT-QUALITY-GATES.md`](SPEC-KIT-QUALITY-GATES.md) | Quality Gates      | Quality gate architecture, resolution logic, configuration        |
| [`docs/SPEC-KIT-CLI.md`](SPEC-KIT-CLI.md)                     | CLI Reference      | Commands, options, workflows, CI/CD integration                   |
| [`docs/SPEC-KIT-ARCHITECTURE.md`](SPEC-KIT-ARCHITECTURE.md)   | Architecture       | Multi-agent, tiered models, consensus, hermetic isolation         |
