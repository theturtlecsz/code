...
| 8 | SPEC-949-IMPL | Extended Model Support Implementation | **BACKLOG** | Code | docs/SPEC-949-extended-model-support/implementation-plan.md | | | 2025-11-16 | **P1 - Week 1-2**: GPT-5/5.1 family integration (5 models), Deepseek/Kimi provider stubs. Cost: -13% ($2.71→$2.36). Performance: 2-3× faster simple stages. Dependencies: SPEC-936 ProviderRegistry (95% complete). **Estimated Effort**: 16-24 hours. **Enables**: SPEC-948 testing with new models. |
| 9 | SPEC-948-IMPL | Modular Pipeline Logic Implementation | **BACKLOG** | Code | docs/SPEC-948-modular-pipeline-logic/implementation-plan.md | | | 2025-11-16 | **P1 - Week 2-3**: Backend stage filtering, CLI flags (--skip-*, --stages=), TOML configs, 3-tier precedence. Creates pipeline_config.rs (250-300 LOC). 4 workflows (prototyping, docs-only, refactoring, debugging). **Estimated Effort**: 20-28 hours. **Depends**: Config infrastructure (exists). **Enables**: SPEC-947 backend. |
| 10 | SPEC-947-IMPL | Pipeline UI Configurator Implementation | **BACKLOG** | Code | docs/SPEC-947-pipeline-ui-configurator/implementation-plan.md | | | 2025-11-16 | **P1 - Week 3-4**: Interactive TUI modal, checkbox-based stage selection, real-time cost/warnings, keyboard navigation (↑↓/Space/Enter/q/Esc). 4 new widgets (800-1,050 LOC). Command: /speckit.configure. **Estimated Effort**: 24-32 hours. **Depends**: SPEC-948 pipeline_config.rs (HARD DEPENDENCY). **User-facing feature**. |

**Total Effort**: 167-239 hours (4-6 weeks at 40h/week) + 60-84 hours (SPEC-947/948/949, 3-4 weeks)
