...
| Order | Task ID | Title | Status | Owners | PRD | Branch | PR | Last Validation | Evidence | Notes |
|-------|---------|-------|--------|--------|-----|--------|----|-----------------|----------|-------|
| 1 | SPEC-KIT-070 | Radical model cost optimization strategy | **Backlog** | Code | docs/SPEC-KIT-070-model-cost-optimization/PRD.md | | | 2025-10-24 | PRD complete, cost analysis done | **CRITICAL**: Current system burns $11 per /speckit.auto run using premium models (Gemini Pro, Claude Sonnet 4, GPT-4 Pro) for ALL tasks regardless of complexity. Unsustainable at scale. **Proposed**: Intelligent task complexity routing using cheap models (Haiku 3.5, Flash 1.5/2.0, 4o-mini) for 80% of operations. **Impact**: 70-90% cost reduction ($11 → $1.50-3.00 per run), enabling 5-10x more automation. **Strategy**: (1) Phase 1: Replace Pro→Flash, 4-Turbo→4o (45-55% reduction), (2) Phase 2: Complexity-based routing, refactor /implement to single premium + validator (70-80% reduction), (3) Phase 3: Dynamic optimization with fallbacks. **Priority**: P0 CRITICAL - Blocks sustainable scaling, must address BEFORE other SPECs. At 100 SPECs/month: current=$1,100, optimized=$150-250. Effort: 3-4 weeks. |
...
| 3 | SPEC-KIT-067 | Add search command to find text in conversation history | **Backlog** | Code | docs/SPEC-KIT-067-add-search-command-to-find-text-in-conversation-history/PRD.md | | | 2025-10-20 | | | Created via /speckit.new |
| 4 | SPEC-KIT-068 | Restore Spec-Kit quality gates | **Backlog** | Code | docs/SPEC-KIT-068-analyze-and-fix-quality-gates/PRD.md | | | 2025-10-22 | | | Created via /speckit.new |
