...
| 11 | MAINT-11 | Refactor ChatWidget monolith | **IN PROGRESS** | Code | Maintainability | | | 2025-12-14 | `codex-rs/tui/src/chatwidget/mod.rs`, `command_render.rs` | Break the `mod.rs` "gravity well" into smaller modules behind stable interfaces. **Phase 1 (P110)**: Extracted command_render.rs (~200 LOC, 8 tests). mod.rs: 23,413→23,213 LOC. **Remaining**: Input submission, slash-command routing, agent status helpers. |
