...
| 22 | SPEC-KIT-956 | Config.toml Cleanup - Remove Stale Agent Expand Commands | **Done** | Code | docs/SPEC-KIT-956-config-cleanup/PRD.md | main | N/A | 2025-11-29 | Phase 1 complete | **PHASE 1 COMPLETE** (2025-11-29, 15 min): Removed stale config entries post SPEC-KIT-902. **Changes**: (1) Deleted kavedarr spec-ops-* commands (35 lines), (2) Deleted [spec_ops_004] sections (6 lines), (3) Deleted commented speckit.new block (85 lines), (4) Deleted ~/.code/spec_ops_004/ (120KB). **Results**: config.toml 551→424 lines (-127, 23%). **PHASE 2 BLOCKED**: Full [[subagents.commands]] removal (~200 lines) blocked by SPEC-KIT-957 (speckit.specify still uses config). |
| 23 | SPEC-KIT-957 | Nativize speckit.specify - Complete SPEC-KIT-902 | **Backlog** | Code | docs/SPEC-KIT-957-specify-nativization/PRD.md | main | N/A | 2025-11-29 | PRD created | SPEC-KIT-902 missed nativizing speckit.specify - ONLY speckit.* command still using config.toml orchestrator pattern. **Scope**: (1) Add SpecStage::Specify to enum, (2) Native prompt building, (3) Tier 1 routing (single agent), (4) Direct execution refactor, (5) Remove ALL speckit.* [[subagents.commands]] (~200 lines). **Unblocks**: SPEC-KIT-956 Phase 2. **Effort**: ~3h. |
