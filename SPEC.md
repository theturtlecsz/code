...
| 3 | SPEC-KIT-936 | Tmux Elimination & Async Orchestration | **IN PROGRESS** | Code | docs/SPEC-KIT-936-tmux-elimination/PRD.md | main | | 2025-11-13 | **P1 - HIGH** ✅ Phase 4/6 COMPLETE (75% done): Async agent execution infrastructure delivered. **Complete**: Phase 1 (Analysis, 10h), Phase 2 (AsyncAgentExecutor trait + DirectProcessExecutor, 8-10h, 23 tests), Phase 3 (Agent tool integration, 6-8h, tmux_enabled removed), Phase 4 (tmux.rs deleted 851 LOC, commits e90971b37 + 3890b66d7). **Remaining**: Phase 5 (Testing & Validation, 8-10h), Phase 6 (Documentation, 2-3h). **Progress**: 10-13h remaining (was 45-65h, 75% complete). **Next**: Phase 5 Task 5.1 - Full test suite execution. |
...
| 10 | SPEC-947-IMPL | Pipeline UI Configurator Implementation | **BACKLOG** | Code | docs/SPEC-947-pipeline-ui-configurator/implementation-plan.md | | | 2025-11-16 | **P1 - READY**: Interactive TUI modal for pipeline configuration. **Dependencies**: SPEC-948 ✅ COMPLETE (pipeline_config.rs available). **Scope**: 4 new widgets (800-1,050 LOC), checkbox stage selection, real-time cost/warnings, keyboard navigation (↑↓/Space/Enter/q/Esc). **Command**: /speckit.configure. **Estimated Effort**: 24-32 hours (1.5-2 weeks). **User-facing feature** - visual configurator vs manual TOML editing. **Ready to start**. |
