...
fn format_architecture_bible(memories: &[LocalMemorySummary]) -> String {
    ...
    out.push_str("# NL_ARCHITECTURE_BIBLE\n\n");
    ...
    // Footer
    out.push_str("---\n\n");
    out.push_str(&format!("_Generated by Stage0 Seeder | {} entries_\n", memories.len()));
...
fn format_stack_justification(
    ...
    out.push_str("# NL_STACK_JUSTIFICATION\n\n");
    ...
    out.push_str("\n---\n\n");
    out.push_str(&format!(
        "_Generated by Stage0 Seeder | {} deps, {} memories_\n",
        cargo_deps.len(),
        memories.len()
    ));
...
fn format_debt_landscape(grouped: &HashMap<String, Vec<DebtItem>>) -> String {
    ...
    out.push_str("# NL_DEBT_LANDSCAPE\n\n");
    ...
    out.push_str("---\n\n");
    out.push_str(&format!(
        "_Generated by Stage0 Seeder | {} modules, {} items_\n",
        grouped.len(),
        total_todos + total_fixmes + total_hacks
    ));
...
fn format_project_diary(memories: &[LocalMemorySummary]) -> String {
    ...
    out.push_str("# NL_PROJECT_DIARY_01\n\n");
...
mod tests {
    ...
    fn test_format_debt_landscape_empty() {
        ...
        assert!(content.contains("0 modules"));
    }
