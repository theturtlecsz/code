//! Spec Status Dashboard — Pure Logic
//!
//! SPEC-KIT-921: Moved from tui/src/spec_status.rs
//!
//! This module contains the pure, UI-independent logic for:
//! - Collecting SPEC status from filesystem (evidence, tracker, packet)
//! - Rendering status as text (Vec<String>)
//!
//! No TUI dependencies. No ChatWidget. Just filesystem reads and formatting.
...
pub struct AgentCoverage {
    pub per_stage: HashMap<StageKind, Vec<AgentOutcome>>,
}
