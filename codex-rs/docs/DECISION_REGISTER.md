<!-- CANONICAL: See docs/DECISIONS.md for the authoritative version -->

# DECISION\_REGISTER.md - Locked Decisions

> **Note**: This is a historical snapshot. The canonical decisions document is at `docs/DECISIONS.md`.
...
| D8  | Memory\_backend config switch                         | LOCKED | 971  |
...
| ID  | Decision                                                        | Status | Spec |
| --- | --------------------------------------------------------------- | ------ | ---- |
| D31 | Memory Card schema v1 (card\_id, card\_type, facts, provenance) | LOCKED | 976  |
...
| D62 | Logic Edge schema v1 (edge\_id, edge\_type, from/to URIs) | LOCKED | 976     |
...
| D90 | b\_latency\_acceptable(250) for P95 check | LOCKED | 972  |
