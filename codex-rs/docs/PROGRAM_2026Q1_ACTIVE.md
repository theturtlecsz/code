<!-- CANONICAL: See docs/PROGRAM.md for the authoritative version -->

# PROGRAM\_2026Q1\_ACTIVE.md - Active Program DAG

> **Note**: This is a historical snapshot. The canonical program document is at `docs/PROGRAM.md`.
...
* [x] Config switch (memory\_backend = memvid | local-memory)
